...
router.post('/register/admin', authenticate, authorize('superadmin', 'institution_admin'), validate(schemas.auth.register), (req, res, next) => ctrl.register(req, res).catch(next))
